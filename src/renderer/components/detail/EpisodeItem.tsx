...
export const EpisodeItem: React.FC<EpisodeItemProps> = ({ episode, onPress, progress, duration }) => {
  ...
  return (
    <button
      ...
      className="group flex items-center gap-3 w-full px-4 py-3 rounded-lg border border-neutral-800/30 bg-neutral-900/40 hover:bg-neutral-800/60 transition-colors text-left"
    >
